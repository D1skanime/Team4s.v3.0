          ...
          <form id="anime-create-form" className={styles.form} onSubmit={props.onSubmit}>
            <section className={workspaceStyles.sectionCard}>
              <div className={workspaceStyles.sectionHeader}>
                ...
                <p className={workspaceStyles.sectionText}>Titel, Typ und Status bestimmen den Kern des Eintrags.</p>
              </div>
                  ...
                  <div className={workspaceStyles.fieldMeta}>
                    ...
                    <div className={workspaceStyles.titleActionRow}>
                      <div className={workspaceStyles.fieldMeta}>
                        {props.titleHint}
                        {isTitleMissing ? (
                          <p className={`${workspaceStyles.fieldNote} ${workspaceStyles.fieldNoteError}`}>
                            Titel ist Pflicht, bevor gespeichert werden kann.
                          </p>
                        ) : (
                          <span className={workspaceStyles.statusInline}>Titel bereit</span>
                        )}
                      </div>
                      {props.titleActions ? <div className={workspaceStyles.titleActions}>{props.titleActions}</div> : null}
                    </div>
                  </div>
                </div>
            ...
            <section className={workspaceStyles.sectionCard}>
              <div className={workspaceStyles.sectionHeader}>
                ...
                <p className={workspaceStyles.sectionText}>Optionale Angaben fuer Sortierung, Varianten und Kontext.</p>
              </div>
            ...
            <section className={workspaceStyles.sectionCard}>
              <div className={workspaceStyles.sectionHeader}>
                ...
                <h2 className={workspaceStyles.sectionTitle}>Genre und Beschreibung</h2>
                <p className={workspaceStyles.sectionText}>Nutze nur Metadaten, die fuer Suche oder Darstellung wirklich helfen.</p>
              </div>
              ...
              <div className={styles.grid}>
                ...
                <div className={`${styles.field} ${workspaceStyles.descriptionField}`}>
                  ...
                  <textarea
                    ...
                    disabled={props.isSubmitting}
                  />
                  <p className={workspaceStyles.fieldNote}>Kurz, eindeutig und ohne Prozess-Text.</p>
                </div>
              </div>
            </section>
          </form>
            ...
            <section className={workspaceStyles.sectionCard}>
              <div className={workspaceStyles.sectionHeader}>
                ...
                <p className={workspaceStyles.sectionText}>
                  Poster ist Pflicht. Lokaler Upload ist fuer diesen Dev-Flow der sichere Weg.
                </p>
              </div>
            ...
            {props.draftAssets ? (
              <section className={workspaceStyles.sectionCard}>
                <div className={workspaceStyles.sectionHeader}>
                  ...
                  <h2 className={workspaceStyles.sectionTitle}>Uebernommene Assets</h2>
                  <p className={workspaceStyles.sectionText}>Nur sichtbar, wenn wirklich eine Vorschau aktiv ist.</p>
                </div>
                {props.draftAssets}
              </section>
            ) : null}
