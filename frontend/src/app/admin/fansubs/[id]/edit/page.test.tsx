...
describe('AdminFansubEditPage token-free wiring', () => {
  ...
  it('opens the project insight workspace when expanding the anime card', async () => {
    ...
    apiMocks.getAnimeCoverage.mockResolvedValue({
      data: [{ anime_id: 13, member_count: 0, covered_role_codes: [], has_project_note: false, has_first_release: false, qualified_release_count: 0, has_completed_project: false, has_collaboration: false }],
    })
  ...
  can_update_own_group_media: false,
    ...
    apiMocks.getAnimeCoverage.mockResolvedValue({
      data: [{ anime_id: 13, member_count: 0, covered_role_codes: [], has_project_note: true, has_first_release: false, qualified_release_count: 0, has_completed_project: false, has_collaboration: false }],
    })
    apiMocks.getAdminFansubAnimeReleases.mockResolvedValue(releaseListResponse([]))
  ...
  it('refreshes anime coverage after saving contribution roles', async () => {
    ...
    apiMocks.getAnimeCoverage
      ...
      .mockResolvedValueOnce({
        data: [{ anime_id: 13, member_count: 1, covered_role_codes: ['timer'], has_project_note: false, has_first_release: false, qualified_release_count: 0, has_completed_project: false, has_collaboration: false }],
      })
    apiMocks.listUnifiedGroupMembers.mockResolvedValue([
      {
        member_id: 55,
