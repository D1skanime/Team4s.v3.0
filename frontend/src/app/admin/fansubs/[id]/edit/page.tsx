...
type SectionKey = 'basic' | 'tags' | 'content' | 'media' | 'links' | 'collaboration' | 'releases' | 'notes'
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.panel}>
        ...
        {activeMainTab !== 'releases' && activeMainTab !== 'notes' ? <form className={styles.fansubEditForm} onSubmit={save}>
