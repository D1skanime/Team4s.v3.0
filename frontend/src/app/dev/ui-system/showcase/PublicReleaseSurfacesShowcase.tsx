    ...
    <Card variant="section">
      ...
      <div className={styles.publicSurfaceStack}>
        <Card
          ...
          description="Dieser Block nutzt eine wiederverwendbare Presentational-Komponente mit Mockdaten. Wenn die Richtung passt, kann dieselbe Komponente in die echte Public-Projektseite wandern."
        />
