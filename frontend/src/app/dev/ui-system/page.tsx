      ...
      <div className={styles.shell}>
        ...
        <Card variant="section">
          ...
          <div className={styles.compositionGrid}>
            ...
            <section className={styles.releaseCompositionShell} aria-labelledby="composition-6-title">
              <div className={styles.releaseCompositionIntro}>
                <h3 id="composition-6-title">Komposition 6 – Card → Accordion → Tabelle → Detailpanel</h3>
