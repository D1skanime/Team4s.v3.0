...
metadata:
  short-description: "exploration capture | explore sketch spike spec capture"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gsd-ns-ideate`.
- Treat all user text after `$gsd-ns-ideate` as `{{GSD_ARGS}}`.
