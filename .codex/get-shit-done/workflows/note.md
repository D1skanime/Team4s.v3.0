...
- **Global scope**: `C:/Users/admin/Documents/Team4s/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/admin/Documents/Team4s/.codex/notes/`)
...
2. Glob `C:/Users/admin/Documents/Team4s/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/admin/Documents/Team4s/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/admin/Documents/Team4s/.codex/notes/` — works in any directory
