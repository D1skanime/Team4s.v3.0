...
```
Task(
  prompt="Read C:/Users/admin/Documents/Team4s/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/admin/Documents/Team4s/.codex/get-shit-done/templates/SECURITY.md`
