...
| 06-T1-accept-page | 66-06 | 5 | P66-SC2 | T-66-06-01 | Token nach Erfolg aus URL entfernt; Login-Redirect mit return_to | build | `npx tsc --noEmit` | ✅ erstellt in W5 | ✅ green |
| 06-T2-groups-page | 66-06 | 5 | P66-SC1, P66-SC2 | T-66-06-03 | Claim-Queue + Neuanlage-Antrags-Queue (D-03) sichtbar | build | `npm run build` | ✅ erstellt in W5 | ✅ green |
