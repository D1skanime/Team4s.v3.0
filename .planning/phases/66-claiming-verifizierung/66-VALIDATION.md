...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 00-T1-stubs-backend | 66-00 | 0 | P66-SC1, P66-SC2, P66-SC3 | — | Test-Stubs kompilieren ohne Implementierung | stub | `go build ./internal/handlers/... ./internal/repository/...` | ❌ erstellt in W0 | ⬜ pending |
| 00-T2-stub-frontend | 66-00 | 0 | P66-SC3 | — | Vitest erkennt VerifiedBadge.test.tsx ohne Fehler | stub | `npm test -- --run VerifiedBadge` | ❌ erstellt in W0 | ⬜ pending |
| 01-T1-migration | 66-01 | 1 | P66-SC2 | T-66-01-02 | token_hash CHECK erzwingt SHA-256-Länge | migration | `powershell -Command "Select-String -Path 'database/migrations/0091_member_claim_invitations.up.sql' -Pattern 'member_claim_invitations','token_hash','char_length'"` | ❌ erstellt in W1 | ⬜ pending |
| 02-T1-claims-repo | 66-02 | 2 | P66-SC1 | T-66-02-01 | Self-Service-Claim nur für eingeloggte App-User; UNIQUE-Invariante | unit | `go test ./internal/repository/... -run TestMemberClaims` | ❌ stubs in W0 | ⬜ pending |
| 02-T2-invitations-repo | 66-02 | 2 | P66-SC2 | T-66-02-03 | Token gehasht (SHA-256, 64), 7 Tage Ablauf, Lifecycle | unit | `go test ./internal/repository/... -run TestMemberClaimInvitation` | ❌ stubs in W0 | ⬜ pending |
| 03-T1-claims-handler | 66-03 | 3 | P66-SC1 | T-66-03-05 | nur 1 verified-Claim pro historischem Member (FOR UPDATE) | unit | `go test ./internal/handlers/... -run TestMemberClaim` | ❌ stubs in W0 | ⬜ pending |
| 03-T2-noindex-handler | 66-03 | 3 | P66-SC3 | T-66-03-06 | noindex-PATCH nur durch Profil-Eigentümer mit verified Claim | unit | `go test ./internal/handlers/... -run "TestNoindex\|TestVerifyClaim"` | ❌ stubs in W0 | ⬜ pending |
