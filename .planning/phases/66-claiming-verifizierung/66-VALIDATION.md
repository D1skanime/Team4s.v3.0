...
| 01-T1-migration | 66-01 | 1 | P66-SC2 | T-66-01-02 | token_hash CHECK erzwingt SHA-256-Länge | migration | `powershell -Command "Select-String -Path 'database/migrations/0092_member_claim_invitations.up.sql' -Pattern 'member_claim_invitations','token_hash','char_length'"` | ❌ erstellt in W1 | ⬜ pending |
