...
- **D-04:** Filter: „Offen“ (Standard, enthält auch „teilweise“ aus D-15), „Bereits vorhanden“, „Alle“. Ein Filter „Zuordnung prüfen“ entfällt in der Liste (siehe D-02); intern bleibt nachvollziehbar, warum ein Eintrag „bereits vorhanden“ ist (welche Referenz gegriffen hat, z. B. als Hinweistext mit Link zum Anime).
