...
- **D-04:** Filter: „Offen“ (Standard), „Bereits vorhanden“, „Alle“. Ein Filter „Zuordnung prüfen“ entfällt in der Liste (siehe D-02); intern bleibt nachvollziehbar, warum ein Eintrag „bereits vorhanden“ ist (welche Referenz gegriffen hat, z. B. als Hinweistext mit Link zum Anime).
- **D-05:** „Mit bestehendem Anime verbinden“ ergänzt beim bestehenden Anime die technische Jellyfin-Referenz über den heute dafür vorgesehenen Schreibpfad (Research: welcher Writer setzt source_links/folder_name heute, z. B. Jellyfin-Resync/Edit). Keine Änderung der Semantik von source/source_links/folder_name (§26); AniSearch-Metadaten des bestehenden Anime werden dabei nicht überschrieben.
