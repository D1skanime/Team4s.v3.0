...
Ausgangscommit `b3b07ff0`, kanonischer Linux-Stand. Discovery und unabhängige Planprüfung sind abgeschlossen: 9 Plans, 25 Tasks, 6 Anforderungen. Plans 161-01 bis 161-06 sind implementiert und verifiziert; 6/9 Plans abgeschlossen, Plan 161-07 läuft. Plan 06 erhält technische Dateidaten bei normalen Saves und prüft explizite Quellenwechsel atomar. 99 Frontendtests und alle fokussierten DB-/Handlergates bestanden. Breiter Zwischenvergleich: exakt 50 bestehende Go-Fehlerüberschriften, keine neuen; Typecheck weiterhin zwei Baselinefehler. Abschlusscommit 16e152a7. Playback, Untertitel und Cacheidentität folgen. D-16: Unbekannte Audio-Sprache erhält Japanisch als Anzeigestandard; Quellwerte und Untertitel bleiben unverändert. Umfang: tatsächliche Jellyfin-Authentifizierung, verwendete API/GetItems-Aufrufe und konsistente MediaSource-Metadaten entlang Import, Speicherung, Playback und öffentlicher Projektion.
