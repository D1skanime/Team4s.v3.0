...
Ausgangscommit `b3b07ff0`, kanonischer Linux-Stand. Discovery und unabhängige Planprüfung sind abgeschlossen: 9 Plans, 25 Tasks, 6 Anforderungen. Plans 161-01 bis 161-03 sind implementiert und verifiziert; 3/9 Plans abgeschlossen, Plan 161-04 läuft. Plan 03: 279 bestandene Prüfungen ohne Skips einschließlich isolierter DB-Fixtures und ausführbarem FFmpeg-Test, Build/Vet grün; Abschlusscommit cc8ba672. Alle neun direkten Jellyfin-HTTP-Aufrufstellen und der Renderer nutzen die gemeinsame Header-Authentifizierung. D-16: Unbekannte Audio-Sprache erhält Japanisch als Anzeigestandard; Quellwerte und Untertitel bleiben unverändert. Umfang: tatsächliche Jellyfin-Authentifizierung, verwendete API/GetItems-Aufrufe und konsistente MediaSource-Metadaten entlang Import, Speicherung, Playback und öffentlicher Projektion.
