...
Ausgangscommit `b3b07ff0`, kanonischer Linux-Stand. Discovery und unabhängige Planprüfung sind abgeschlossen: 9 Plans, 25 Tasks, 6 Anforderungen. Plans 161-01 bis 161-05 sind implementiert und verifiziert; 5/9 Plans abgeschlossen, Plan 161-06 läuft. Plan 05: Revalidierung bestätigter Quellen vor jedem Import, atomare Quellenmetadaten und idempotenter Releasegraph mit echten isolierten PostgreSQL-Tests belegt. 27 tatsächliche 11eyes-Items bleiben 27 Kandidaten; Apply benötigt ceil(N/100) Providerabrufe und eine Binding-Abfrage. Backend-Build, Vet und Diffprüfung bestanden. Abschlusscommit ec78ca12. Editor-Erhalt und explizite Relinks folgen. D-16: Unbekannte Audio-Sprache erhält Japanisch als Anzeigestandard; Quellwerte und Untertitel bleiben unverändert. Umfang: tatsächliche Jellyfin-Authentifizierung, verwendete API/GetItems-Aufrufe und konsistente MediaSource-Metadaten entlang Import, Speicherung, Playback und öffentlicher Projektion.
