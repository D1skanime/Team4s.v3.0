...
- [x] **REQ-167-10**: Der bestehende Auto-Upsert aus Dateinamen entfällt; eine unaufgelöste Zeile erzeugt beim Anwenden keine neue `fansub_groups`-Zeile mehr (D-03).
...
- [x] **REQ-167-13**: Ordnet der Admin ein erkanntes, bisher unbekanntes Kürzel einer bestehenden Gruppe zu, wird es automatisch als weiterer Alias dieser Gruppe gespeichert (D-01).
...
- [x] **REQ-167-21**: Doppelfolgen (`Naruto_026-027`-Schema) werden im bestehenden Import-Verhalten geprüft und dokumentiert; die Episodenzuordnung selbst ändert sich durch diese Phase nicht (Scopegrenze).
