...
- [x] **Phase 2: Manual Intake Baseline** - Deliver the manual preview-before-save workflow with minimum-field creation and existing cover upload.
- [x] **Phase 3: Jellyfin-Assisted Intake** - Add Jellyfin source selection and draft prefill without hidden persistence.
- [x] **Phase 4.1: Anime v2 Cutover Stabilization** - Stabilize the live v2 anime create/edit/read stack so cover upload, admin save, source linkage, and operator-facing errors behave reliably before broader provenance work resumes.
- [x] **Phase 4: Provenance, Assets, And Safe Resync** - Expose source provenance, per-slot asset handling, and fill-only resync behavior.
- [x] **Phase 5: Relations And Reliability** - Complete relation CRUD and validation-centered admin reliability on top of the stabilized ownership model.
...
- [x] 03-02-PLAN.md - Build the typed compact-first intake client and hook seam on the new backend contracts.
- [x] 03-07-PLAN.md - Build the rich Jellyfin candidate-card review UI on top of the intake hook seam.
...
- [x] 03-05-PLAN.md - Expose folder-name title seeding in the intake preview contract and shared create draft without reopening deferred upload scope.
- [x] 03-06-PLAN.md - Collapse takeover into a draft-only active view so competing Jellyfin matches disappear until search is explicitly restarted.
**UI hint**: yes
...
**Plans**: 3 plans
Plans:
- [x] 04-01-PLAN.md - Stabilize persisted Jellyfin provenance plus explicit fill-only metadata preview/apply contracts for existing anime.
- [x] 04-02-PLAN.md - Finish ownership-aware cover/banner/background persistence, slot actions, and persisted-over-fallback runtime reads.
- [x] 04-03-PLAN.md - Bring the edit route to the approved provenance-first operator UX with clear German ownership and slot-action feedback.
**UI hint**: yes
...
**Plans**: 2 plans
Plans:
- [x] 04.1-01-PLAN.md - Stabilize schema-aware v2 create, edit, and read persistence so mixed local schemas, cover readback, and Jellyfin linkage stay reliable.
- [x] 04.1-02-PLAN.md - Surface operator-usable admin anime save and cover-patch errors through handlers, the API client, and the shared edit mutation seam.
**UI hint**: yes
...
**Plans**: 3 plans
Plans:
- [x] 05-01-PLAN.md - Add the authenticated admin relation contract, V1 label mapping, target search, and normalized-table CRUD foundation.
- [x] 05-02-PLAN.md - Build the default-collapsed edit-route relation section with live search, create flow, and persistent validation feedback.
- [x] 05-03-PLAN.md - Finish inline relation maintenance with edit/delete actions, confirmation, and stale-list-safe refresh behavior.
**UI hint**: yes
...
| 2. Manual Intake Baseline | 3/3 | Complete | 2026-04-01 |
| 3. Jellyfin-Assisted Intake | 7/7 | Complete | 2026-03-31 |
| 4.1. Anime v2 Cutover Stabilization | 2/2 | Complete | 2026-03-31 |
| 4. Provenance, Assets, And Safe Resync | 3/3 | Complete    | 2026-03-31 |
| 5. Relations And Reliability | 3/3 | Complete | 2026-04-01 |
