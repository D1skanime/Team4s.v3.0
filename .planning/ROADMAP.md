...
- [ ] 135-09-PLAN.md — Keycloak-Registrierung auf Fansubname umbauen; First/Last optional; KC autoritativ + JIT-Sync (D-14).
- [ ] 135-10-PLAN.md — Case-preserved Fansubname (Anzeige, KC) + Historisch-Selbst-Claim Approval-Render (D-15, D-16, Finding #25).
