...
OUT = ROOT / ".planning/quick/260914-fc1-segment-assignment-slot-conflicts"
PG = "team4s-quick-fc1-final-db"
GO = "team4s-quick-fc1-final-go"
LABEL = "team4s.quick=260914-fc1-final"
OWNED = {}
...
try:
    ...
    OWNED[PG] = call(["docker", "run", "--detach", "--name", PG,
        ...
        "-e", "POSTGRES_DB=team4s_phase117_test_fc1", "postgres:16",
    ...
    command = ["docker", "exec", "-e", f"TEAM4S_PHASE117_TEST_DSN=postgres://postgres@{PG}:5432/team4s_phase117_test_fc1?sslmode=disable",
        GO, "go", "test", "-p", "1", "./internal/handlers", "./internal/repository",
        "-run", "SegmentSlot|ThemeSegmentAssignmentsAndOverrides|AssignThemeSegmentToEpisodeRange|UpsertReleaseVersionGroupAutoAssign|CreateAnimeSegment_|UpdateAnimeSegment_|ThemeSegmentPlaybackResolution|GetAnimeSegmentByID_Hydrates|ListAnimeSegmentsAssignedEpisodes|TestSetThemeSegmentOrigin|TestLoadReleaseSegmentsQueryBudgetIsConstant", "-count=1", "-json"]
    started = time.time()
